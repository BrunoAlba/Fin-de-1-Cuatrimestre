...
arregloInicial[0][1] = 'Sesion de Maternidad';
arregloInicial[0][2] = 'Para editar';
...
const dibujarTabla = () => {
    ...
    <button onclick="eliminarTarea(${tarea[0]})" type="button" class="btn btn-outline-success">Eliminar Sesion</button>
    </td></tr>`;
		html += trHtml;
	}
